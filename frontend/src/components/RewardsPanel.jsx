  ...
  const rewards = [
    {
      ...
      cost: 150,
      description: 'Funds the planting and monitoring of one native mangrove tree in Madagascar.',
      icon: Heart,
      color: 'text-emerald-400 bg-emerald-400/10 border-emerald-500/20',
      successMsg: '🌳 Offsetting Active! We have funded a certified tree planting in Madagascar on your behalf.',
    },
    {
      id: 'grocery',
      title: '15% Off Organic Grocery',
      partner: 'GreenBasket Markets',
      cost: 100,
      description: 'Get 15% off your next delivery of organic, locally sourced vegetables.',
      icon: ShoppingBag,
    ...
    },
    {
      ...
      partner: 'BluSmart EV Cabs',
      cost: 80,
      description: 'Redeem for ₹50 off your next electric cab ride in Delhi/Mumbai/Bengaluru.',
      icon: Car,
      color: 'text-sky-400 bg-sky-400/10 border-sky-500/20',
      successMsg: '⚡ Ride discount code: BLUSMART-50ECO. Enter in the BluSmart app!',
    },
  ]
